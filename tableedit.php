...
<ol id="toc">
    <li><a href="#inventory"><span><i class="glyphicon glyphicon-list-alt"></i> Inventory</span></a></li>
    <li><a href="#sales"><span><i class="glyphicon glyphicon-btc"></i> Sales</span></a></li>
    <!-- <li><a href="#alert"><span>To be order</span></a></li> -->
	<li><a href="#addproitem"><span><i class="glyphicon glyphicon-th-list"></i> Add Item</span></a></li>
    <li><a href="#addpro"><span><i class="glyphicon glyphicon-ruble"></i> Add Product</span></a></li>
    <li><a href="#editprice"><span><i class="glyphicon glyphicon-btc"></i> Edit Price</span></a></li>
	<!--<li><a href="index.php"><span>Logout</span></a></li>-->
</ol>

<div class="content" id="inventory">
Click the table rows to enter the Quantity Sold then Click Enter. (Press F5 to Refresh)<br><br>
<table width="100%">
<tr class="head">
<th>Date</th>
<th>Product</th>
